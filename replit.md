...
- **External Services**: Neon Database (serverless PostgreSQL), Google Gemini AI (requires `GEMINI_API_KEY`), Unsplash (placeholder images), PostgreSQL-backed sessions (configured).